...
// poll-weather fetches with temperature_unit=fahrenheit, so all temperature
// fields arrive as °F. When a condition stores unit:'celsius', convert the
// raw °F value to °C before comparing against the Celsius threshold.
